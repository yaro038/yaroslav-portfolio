...
export function Contact() {
  ...
  return (
    <section
      id="contact"
      ref={root}
      className="relative z-[1] flex min-h-[90svh] flex-col justify-between overflow-hidden border-t border-line px-[clamp(1.25rem,4vw,3.5rem)] py-16 md:py-20"
    >
      ...
      <div className="relative z-10">
        <p className="contact-line font-mono text-xs text-accent">04 — CONTACT</p>
        <h2 className="contact-line display mt-4 max-w-5xl text-[clamp(2.6rem,9vw,7rem)] text-ink">
          Let’s ship the next surface.
        </h2>
      </div>

      <div className="relative z-10 mt-16 grid gap-10 md:mt-0 md:grid-cols-[1fr_auto] md:items-end">
        <a
